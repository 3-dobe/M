...
from dataset.normalize import HAAR_SIZE
...
if __name__ == '__main__':
    ...
    # 24*24
    img_n = ImgUtil.complete_scale_to_array(p_1, HAAR_SIZE)
    # img_n.save(n_p_1, "png")
    haar_n_p_1 = Haar(p_1, img_n)
    Log.d(haar_n_p_1[0:100])
    # 48*48
    img_n2 = ImgUtil.complete_scale_to_array(p_1, 2 * HAAR_SIZE)
    # img_n2.save(n2_p_1, "png")
    haar_n2_p_1 = Haar(p_1, img_n2, 2)
    Log.d(haar_n2_p_1[0:100])
    Log.d("ok")
